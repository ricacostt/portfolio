    ...
    <div className="flex flex-row justify-center card scale-75 xsm:scale-90 md:scale-100 max-w-sm shrink-0 shadow bg-buttonsecondarylight dark:bg-bgcard origin-top-left border border-buttonprimarydark	dark:border-bgdarkopa">
      <div className="card-body gap-4">
        ...
        <div className="flex flex-row flex-wrap text-xsm gap-2 pb-4 text-textlight dark:text-textdark">
          <a
            aria-label="Read more about the API"
        ...
        <div className="card-actions justify-start gap-10">
          {github && (
            <a
              aria-label="Read more about the code in github"
              href={github}
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              Discover
              <VscGithubAlt className=" w-5 h-5 ml-2 stroke-textlight dark:stroke-textdark  hover:stroke-buttontextlight dark:hover:stroke-textaccent" />
            </a>
          )}

          {href && (
            <a
              aria-label="Read more about the live demo"
              href={href}
              target="_blank"
              rel="noopener noreferrer"
          ...
          {figma && (
            <a
              aria-label="Read more about the figma prototype"
              href={figma}
              target="_blank"
              rel="noopener noreferrer"
          ...
          {presentation && (
            <a
              aria-label="Read more about the project, ask for permission to see presentation"
              href={presentation}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center text-textlight dark:text-textdark hover:underline text-base stroke-textlight  dark:stroke-textdark hover:text-textaccent dark:hover:text-textaccent hover:stroke-textaccent dark:hover:stroke-textaccent"
