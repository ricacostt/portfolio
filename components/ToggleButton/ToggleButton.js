...
const ToggleButton = () => {
  ...
  <div className=" w-5 h-3 xsm:w-11 xsm:h-6 rounded-full dark:border-4 dark:border-bglight bg-textlight  peer peer-focus:ring-4  peer-focus:to-buttonsecondarylight dark:peer-focus:to-buttonsecondarydark peer-checked:after:translate-x-full peer-checked:after:border-4 peer-checked:after:border-white  after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:border after:rounded-full after:h-2 after:w-2 xsm:after:h-5 xsm:after:w-5 after:transition-all dark:to-buttonsecondarydark peer-checked:border-white-2 after:border-4 " ></div>
