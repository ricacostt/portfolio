...
const ToggleButton = () => {
  ...
  {/* <div className="w-11 h-6 border-2 border-buttonsecondarydark bg-textlight rounded-full peer peer-focus:ring-4 peer-focus:to-buttonsecondarylight dark:peer-focus:to-buttonsecondarydark dark:bg-textdark peer-checked:after:translate-x-full peer-checked:after:border-4 peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-buttonsecondarydark after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:to-buttonsecondarydark peer-checked:border-white-200"></div> */}
  <span className="ml-3 text-sm font-medium text-textlight dark:text-textdark">switch me off</span>
</label>
